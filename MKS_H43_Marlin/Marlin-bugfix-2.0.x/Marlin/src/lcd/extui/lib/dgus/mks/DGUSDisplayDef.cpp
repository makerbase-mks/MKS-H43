...
#include "../../../../marlinui.h"
  ...
  float level_1_x_point = 20;
  float level_1_y_point = 20;
  float level_2_x_point = 20;
  float level_2_y_point = 20;
  float level_3_x_point = 20;
  float level_3_y_point = 20;
  float level_4_x_point = 20;
  float level_4_y_point = 20;
  float level_5_x_point = X_MAX_POS/2;
  float level_5_y_point = Y_MAX_POS/2;
...
const char H43Version[] PROGMEM = "MKS H43_V1.13";  
const char Updata_Time[] PROGMEM = STRING_DISTRIBUTION_DATE;

// const uint16_t Home_dis[] PROGMEM = {0xF7D6,0xB3D2}; 
// const uint16_t Setting_Dis[] PROGMEM = {0xE8C9,0xC3D6};
...
const struct DGUS_VP_Variable ListOfVP[] PROGMEM = {
  ...
  // Temperature Data
    ...
    VPHELPER(VP_E0_STATUS, &thermalManager.temp_hotend[0].target, nullptr, &ScreenHandler.DGUSLCD_SendHeaterStatusToDisplay),
      ...
      VPHELPER(VP_E0_FILAMENT_LOAD_UNLOAD, nullptr, &ScreenHandler.HandleFilamentOption, &ScreenHandler.HandleFilamentLoadUnload),
        ...
        VPHELPER(VP_Filament_speed, &FilamentSpeed, &ScreenHandler.GetManualFilamentSpeed, ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<0>),
      #endif
    #endif
  #endif
  #if HOTENDS >= 2
  ...
  // Level Point Set
  VPHELPER(VP_Level_Point_One_X, &level_1_x_point, ScreenHandler.HandleChangeLevelPoint_MKS, ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<0>),
  VPHELPER(VP_Level_Point_One_Y, &level_1_y_point, ScreenHandler.HandleChangeLevelPoint_MKS, ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<0>),
  VPHELPER(VP_Level_Point_Two_X, &level_2_x_point, ScreenHandler.HandleChangeLevelPoint_MKS, ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<0>),
  VPHELPER(VP_Level_Point_Two_Y, &level_2_y_point, ScreenHandler.HandleChangeLevelPoint_MKS, ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<0>),
  VPHELPER(VP_Level_Point_Three_X, &level_3_x_point, ScreenHandler.HandleChangeLevelPoint_MKS, ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<0>),
  VPHELPER(VP_Level_Point_Three_Y, &level_3_y_point, ScreenHandler.HandleChangeLevelPoint_MKS, ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<0>),
  VPHELPER(VP_Level_Point_Four_X, &level_4_x_point, ScreenHandler.HandleChangeLevelPoint_MKS, ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<0>),
  VPHELPER(VP_Level_Point_Four_Y, &level_4_y_point, ScreenHandler.HandleChangeLevelPoint_MKS, ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<0>),
  VPHELPER(VP_Level_Point_Five_X, &level_5_x_point, ScreenHandler.HandleChangeLevelPoint_MKS, ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<0>),
  VPHELPER(VP_Level_Point_Five_Y, &level_5_y_point, ScreenHandler.HandleChangeLevelPoint_MKS, ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<0>),
  ...
  // VPHELPER_STR(VP_PrintTime_H, nullptr, 10, nullptr, ScreenHandler.DGUSLCD_SendPrintTimeToDisplay_MKS),
  // VPHELPER_STR(VP_PrintTime_M, nullptr, 10, nullptr, ScreenHandler.DGUSLCD_SendPrintTimeToDisplay_MKS),
  // VPHELPER_STR(VP_PrintTime_S, nullptr, 10, nullptr, ScreenHandler.DGUSLCD_SendPrintTimeToDisplay_MKS),
  // VPHELPER(VP_PrintTime_H, &tim_h, ScreenHandler.GetPrintTime_MKS,ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<0>),
  // VPHELPER(VP_PrintTime_M, &tim_m, ScreenHandler.GetPrintTime_MKS,ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<0>),
  // VPHELPER(VP_PrintTime_S, &tim_s, ScreenHandler.GetPrintTime_MKS,ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<0>),
  #endif
  ...
  VPHELPER(VP_MESH_LEVEL_POINT, &current_position.z, ScreenHandler.MeshLevel, ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<2>),
  ...
  // SDCard File listing.
    ...
    VPHELPER(VP_SD_Print_Setting, nullptr, ScreenHandler.DGUSLCD_SD_PrintTune, nullptr),
      ...
      #else
      VPHELPER(VP_SD_Print_ProbeOffsetZ, &probe.offset.z, ScreenHandler.HandleProbeOffsetZChanged_MKS, &ScreenHandler.DGUSLCD_SendFloatAsIntValueToDisplay<2>),
        #if ENABLED(BABYSTEPPING)
        VPHELPER(VP_SD_Print_LiveAdjustZ, ZOffset_distance, ScreenHandler.HandleLiveAdjustZ, &ScreenHandler.DGUSLCD_SendBabyStepToDisplay_MKS),    
        #endif
      #endif
