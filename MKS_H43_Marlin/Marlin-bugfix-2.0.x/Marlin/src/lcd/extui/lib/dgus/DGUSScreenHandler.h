...
public:
  ...
  static void GetPrintTime_MKS(DGUS_VP_Variable &var, void *val_ptr);
  ...
  static void HandleMin_T_F_MKS(DGUS_VP_Variable &var, void *val_ptr);
    ...
    #else
    static void HandleProbeOffsetZChanged_MKS(DGUS_VP_Variable &var, void *val_ptr);
    #endif
  #endif
...
private:
  ...
  static uint16_t DGUSLanguageSwitch;
